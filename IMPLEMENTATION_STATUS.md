...
2026-07-15 已增加房间设备台账与可解释设备画像：八房间总览展示设备级类型概率和使用状态；详情聚合历史并支持通用类型人工修正。合并后 2312 新一轮真实本机采样显示 2 个匿名设备：稳定出现的“电视/媒体设备”候选（82% 类型证据，2/2 样本命中）和一个低证据“手机/平板/电脑候选”（30%，1/2 样本命中）。两者使用情况均保持“使用未知”，没有伪造流量或播放结论。当前电脑仍只保存 2312 的 Wi-Fi profile，正式八房间真实台账尚未通过现场 Gate A。
