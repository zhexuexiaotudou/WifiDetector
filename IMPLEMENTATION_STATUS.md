...
2026-07-15 已增加房间设备台账与可解释设备画像：八房间总览展示设备级类型概率和使用状态；详情聚合历史并支持通用类型人工修正。2312 真实本机数据验证得到 1 个“电视/媒体设备”候选（82% 类型证据），使用情况保持“媒体服务可见，使用未知”（35% 证据），没有伪造流量或播放结论。当前电脑仍只保存 2312 的 Wi-Fi profile，正式八房间真实台账尚未通过现场 Gate A。
